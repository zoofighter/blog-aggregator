...
class ParallelBlogCrawler:
    ...
    def crawl_all_blogs_parallel(self, limit_per_blog: int = 10, verbose: bool = False):
        """모든 활성 블로그를 병렬로 크롤링"""
        ...
        print(f"\n🚀 {total_blogs}개 블로그 병렬 크롤링 시작 ({self.max_workers} 스레드)")
...
def main():
    ...
    crawler.crawl_all_blogs_parallel(limit_per_blog=args.limit, verbose=args.verbose)
